...
package com.jskno.budgetgenerator.model.ui.customElements;
...
public class MyTextFieldTableCell<S,T> extends TableCell<S,T> {
    ...
    public static <S,T> Callback<TableColumn<S,T>, TableCell<S,T>> forTableColumn(
        ...
        return list -> new MyTextFieldTableCell<S,T>(converter);
    }
    ...
    public MyTextFieldTableCell(StringConverter<T> converter) {
        ...
        this.textField.addEventFilter(KeyEvent.KEY_TYPED, keyEvent -> {
